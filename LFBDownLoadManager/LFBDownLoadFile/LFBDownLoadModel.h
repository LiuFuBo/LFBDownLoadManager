...
@interface LFBDownLoadModel : NSObject
@property (nonatomic, copy) NSString *localPath;//下载完成路径
@property (nonatomic, copy) NSString *vid;//文件唯一标识id
...
@property (nonatomic, assign) NSUInteger tmpFileSize; //已下载文件大小
@property (nonatomic, assign) NSUInteger speed; //下载速度
@property (nonatomic, assign) NSTimeInterval lastSpeedTime; //上次计算速度时间戳
